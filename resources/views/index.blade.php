...
<body>
  ...
  <![endif]-->    
        ...
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-center">
                <div class="px-4 mt-30">
                    <img src="assets/images/brand-1.png" style="border-radius:15px">
                </div> 
                <div class="px-4 mt-30">
                    <img src="assets/images/brand-2.png" style="border-radius:15px">
                </div> 
                <div class="px-4 mt-30">
                    <img src="assets/images/brand-3.png" style="border-radius:15px">
                </div> 
            </div>
        </div>
    </div>
    ...
    <footer id="footer" class="footer-area pt-120 pb-120">
        <div class="container">
            <div class="subscribe-area wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subscribe-content mt-45">
                            <h2 class="subscribe-title">მიიღე სიახლეები ჩვენი ვებსაიტიდან</h2>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="subscribe-form mt-50">
                            <form action="#">
                                ...
                                <button class="main-btn">გამოწერა</button>
                            </form>
                        </div>
                    </div>
                 </div> <!-- row -->
